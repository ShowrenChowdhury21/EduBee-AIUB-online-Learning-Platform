          ...
          <ul class="nav navbar-nav">
                   ...
                   <div id="addEmployeeModal" class="modal fade">
                    ...
                    <div class="modal-dialog">
                     <div class="modal-content">
                      <form action = "/instructor/myinbox/storemail" method = "post">
            ...
            <!-- compose-->
                   <div id="readmodal" class="modal fade">
                    <div class="modal-dialog">
                     <div class="modal-content">
                      <form action = "/instructor/myinbox/reademail" method = "post" id="editform">
                       <div class="modal-header">
            ...
            <!-- edit-->
                   ...
                   <div id="editEmployeeModal" class="modal fade">
                    <div class="modal-dialog">
                     <div class="modal-content">
                      <form action = "/instructor/myinbox/storereply" method = "post" id="editform">
                       <div class="modal-header">
            ...
            <!-- edit-->
                   <div id="deleteEmployeeModal" class="modal fade">
                    <div class="modal-dialog">
                     <div class="modal-content">
                      <form action="/instructor/myinbox/deletemail" method="post" id="deleteform">
                       <div class="modal-header">
            ...
            <script>
              ...
              $(".edit").on('click',function(){
                ...
                $('#to').val(editdata[0]);
                $('#editform').attr('action','/instructor/myinbox/replyemail/'+editdata[0]);
              });
              $(".delete").on('click',function(){
                ...
                console.log(editdata);
                $('#to').val(editdata[2]);
                $('#deleteform').attr('action','/instructor/myinbox/deleteemail/'+editdata[2]);
              });
