  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-8">
        ...
        {!! Form::open(['action'=>['forumController@update', $post->id],'method'=>'POST','enctype'=>'multipart/form-data']) !!}
            ...
            <div class="form-group">
              ...
              {{Form::textarea('body',$post->body,[ 'id' => 'summary-ckeditor','class'=>'form-control','placeholder'=>'write details'])}}
            </div>
