      ...
      <nav class="navbar navbar-default">
        ...
        <div id="main">
          <div class="myaccount">
            ...
            <h1 class="studentname" style="font-size: 35px;">Showren Chowdhury</h1>
            <h1 class="studentid" style="font-size: 25px;">17-*****-2</h1>
            <h1 class="department">Department: <span>Computer Science and Engineering</span></h1>
            <h1 class="email">E-mail: <span>Showren@email.com</span></h1>
