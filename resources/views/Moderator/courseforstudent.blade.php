<html lang="en">
  ...
  <body>
   ...
   <div id="editEmployeeModal" class="modal fade">
    <div class="modal-dialog">
     <div class="modal-content">
      <form action = "/moderator/courseforstudent/updatecourseforstudent" method = "post" id="editform">
       <div class="modal-header">
   ...
   <div id="deleteEmployeeModal" class="modal fade">
    <div class="modal-dialog">
     <div class="modal-content">
      <form action = "/moderator/courseforstudent/deletecourseforstudent" method = "post" id="deleteform">
       <div class="modal-header">
...
<script type="text/javascript">
  $(document).ready(function(){
      $('tbody').on('click', 'a', function(){
          ...
          $('#deleteform').attr('action','/moderator/courseforstudent/deletecourseforstudent/'+value_id);
      });
  });
  ...
  $(document).ready(function(){
    ...
    $(".edit").on('click',function(){
        ...
        $('#editform').attr('action','/moderator/courseforstudent/updatecourseforstudent/'+editdata[0]);
    });
  });
