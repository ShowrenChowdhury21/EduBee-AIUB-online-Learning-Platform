  ...
  <script src="{{ asset('asset/js/admin.js') }}"></script>
              ...
              <body>
                <div class="side-nav" id="show-side-navigation1">
                  ...
                  <ul class="categories" style="margin-top: 60px;">
                    ...
                    <li></i><a href="/admin/departmentmanagement">&nbsp;&nbsp;Department Management</a></li>
                        ...
                        <ul class="nav navbar-nav">
                          <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                              ...
                              <li><a href="/adminadmin/myinbox"><i class="fa fa-envelope-o fw"></i> My inbox</a></li>
                   ...
                   <div id="addEmployeeModal" class="modal fade">
                    ...
                    <div class="modal-dialog">
                     <div class="modal-content">
                      <form action = "/admin/myinbox/storemail" method = "post">
            ...
            <!-- compose-->
                   <div id="readmodal" class="modal fade">
                    <div class="modal-dialog">
                     <div class="modal-content">
                      <form action = "/admin/myinbox/reademail" method = "post" id="editform">
                       <div class="modal-header">
            ...
            <!-- edit-->
                   ...
                   <div id="editEmployeeModal" class="modal fade">
                    <div class="modal-dialog">
                     <div class="modal-content">
                      <form action = "/admin/myinbox/storereply" method = "post" id="editform">
                       <div class="modal-header">
            ...
            <!-- edit-->
                   <div id="deleteEmployeeModal" class="modal fade">
                    <div class="modal-dialog">
                     <div class="modal-content">
                      <form action="/admin/myinbox/deletemail" method="post" id="deleteform">
                       <div class="modal-header">
            ...
            <script>
              ...
              $(".edit").on('click',function(){
                ...
                $('#to').val(editdata[0]);
                $('#editform').attr('action','/admin/myinbox/replyemail/'+editdata[0]);
              });
              $(".delete").on('click',function(){
                ...
                console.log(editdata);
                $('#to').val(editdata[2]);
                $('#deleteform').attr('action','/admin/myinbox/deleteemail/'+editdata[2]);
              });
